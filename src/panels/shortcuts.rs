...
pub const BUILTIN_SHORTCUTS: &[(&str, &str, &str)] = &[
    ...
    ("canvas_cut", "Ctrl+X", "Cut selected widgets"),
...
fn show_reference(ui: &mut egui::Ui, user_shortcuts: &HashMap<String, String>) {
    egui::ScrollArea::vertical().show(ui, |ui| {
        ...
        ref_row(ui, "canvas_cut", user_shortcuts);
        ref_row(ui, "canvas_paste", user_shortcuts);
        ref_row(ui, "canvas_duplicate", user_shortcuts);
        row(ui, "Right-click", "Copy / Cut / Paste / Duplicate menu");
...
mod tests {
    ...
    fn clipboard_shortcuts_registered() {
        ...
        assert!(ids.contains(&"canvas_cut"));
