...
## Session Rules
- Every session ends with `cargo run` confirming a clean launch unless the user asks for a read-only pass.
- Zero warnings is required before any implementation session is considered done.
